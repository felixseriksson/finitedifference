...
def visualisefixedsquare():
    plt.plot([2, 3.4],[2.7, 2.7],"k")
    plt.plot([2, 3.4],[1.3, 1.3],"k")
    plt.plot([2, 2],[1.3, 2.7],"k")
    plt.plot([3.4, 3.4],[1.3, 2.7],"k")

def savesnap(dtstring,number):
    plt.savefig("C:\\Users\\felix\\Documents\\GitHub\\gymnasiearbete\\model\\images\\"+str(dtstring)+"\\"+str(number)+".png")
